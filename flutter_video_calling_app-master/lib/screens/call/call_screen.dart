...
class _CallScreenState extends State<CallScreen> {
    ...
    return Container(
      ...
      child: Row(
        ...
        children: <Widget>[
          ...
          RawMaterialButton(
            onPressed: () => _onToggleDisableVideo(notifier),
            child: Icon(
              notifier.isVideoPause ? Icons.videocam_off : Icons.videocam,
              color: notifier.isVideoPause ? Colors.white : Colors.teal,
              size: 20.0,
            ),
            shape: CircleBorder(),
            elevation: 2.0,
            fillColor: notifier.isVideoPause ? Colors.teal : Colors.white,
            padding: const EdgeInsets.all(12.0),
          ),
          RawMaterialButton(
  ...
  void _onToggleDisableVideo(CallNotifier notifier) {
    notifier.isVideoPause = notifier.isVideoPause;
    notifier.engine.muteLocalVideoStream(notifier.isVideoPause);
  }
